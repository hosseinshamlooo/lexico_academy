...
function CheckIcon({ color = "#1D5554" }) {
  return (
    <svg
...
export default function Pricing() {
  return (
    ...
    >
      ...
      <p className="text-gray-400 text-base md:text-lg text-center max-w-2xl mb-12">
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-6xl justify-center items-stretch px-4 md:px-0">
        {/* Free Tier */}
        <div className="relative flex flex-col w-[370px] rounded-3xl border-2 border-[#1D5554] bg-white text-[#1D5554] transition-all duration-300 p-8 md:p-10 shadow-[0_8px_0_0_#1D5554]">
          <div className="mb-2 text-xs font-bold uppercase tracking-wider opacity-80">
            FREE TIER
          </div>
          <div className="flex items-end mb-1 mt-2">
            <span className="text-3xl font-extrabold leading-none text-[#1D5554]">
              0
            </span>
        ...
        {/* Lexico Pro */}
        <div className="relative flex flex-col w-[370px]  rounded-3xl border-2 border-[#1D5554] bg-[#1D5554] text-white transition-all duration-300 p-8 md:p-10 z-10 scale-105 md:-mt-6">
        ...
        <div className="relative flex flex-col w-[370px] rounded-3xl border-2 border-[#1D5554] bg-white text-[#1D5554] transition-all duration-300 p-8 md:p-10 shadow-[0_8px_0_0_#1D5554]">
          ...
          <ul className="mb-8 mt-6 space-y-3 text-sm text-left">
            ...
            <li className="flex items-start">
              <CheckIcon color="#1D5554" />
              <span>Bonus 1-on-1 coaching session</span>
            </li>
            <li className="flex items-start">
              <CheckIcon color="#1D5554" />
              <span>
